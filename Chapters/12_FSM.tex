...
Using the above state diagram, a simulated elevator could be constructed with \Le and all of the functions checked using the simulator. Once that is done, the circuit could be realized and implemented on an \gls{ic} for use in the physical elevator control circuit.
